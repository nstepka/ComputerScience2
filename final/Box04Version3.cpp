...
//	double* fillingNumber = new double;  //double to add default numbers of 1 to box data types
//	*fillingNumber = 1;
//	length = new double(sizeof(fillingNumber));             //allocate memory
//    width = new double(sizeof(fillingNumber));
//    height = new double(sizeof(fillingNumber));
//    setLenth(sizeof(fillingNumber));
//    setWidth(sizeof(fillingNumber));
//    setHeight(sizeof(fillingNumber));
	length = new double(sizeof(0));             //allocate memory
    width = new double(sizeof(0));
    height = new double(sizeof(0));
        
    setLength(0);                    //sets all Coordinates to 0
    setWidth(0);
    setHeight(0);
...
Box ::  Box(double x)
{
	...
	length = new double(sizeof(x));             //allocate memory
    width = new double(sizeof(x));
    height = new double(sizeof(x));
	setLength(length);
	setWidth(width);
	setHeight(height);
}
Box ::  Box(double l, double w, double h)
{
	...
	length = new double(sizeof(l));     //allocate memory
    width = new double(sizeof(w));
    height = new double(sizeof(h));

    setLength(length);                    //sets all Coordinates in x y z order 
    setWidth(width);
    setHeight(height);
}
/**********************
