...
{
	cout << "In Date()\n";
	int* fillingNumber = new int;  //double to add default numbers of 1 to box data types
	*fillingNumber = 1;
	
	setMonth(fillingNumber);
	setDay(fillingNumber);
	setYear(fillingNumber);
...
{
	cout << "in date(m,d,y)\n";
	month = new int(sizeof(m));     //allocate memory
    day = new int(sizeof(d));
    year = new int(sizeof(y));
    cout << year << "hi\n";
    cout << *year << "hi\n";
	setMonth(month);
	setDay(day);
...
{
	cout << "\nin testDate03()\n";
	int* date = new int;  //double to add default numbers of 1 to box data types
	*date = 12;
	int* month = new int;  //double to add default numbers of 1 to box data types
	*month = 31;
	int* year = new int;  //double to add default numbers of 1 to box data types
	*year = 2019;
	
	Date d1;						//calls Date()
	Date d2(12,31,2021);			//calls Date(int m,int d, int y)
...
void testDate04()					//tester to make sure d1 intializes, and d2 intializes with numbers given.
{
	cout << "\nin testDate04()\n";
	int* date = new int;  //double to add default numbers of 1 to box data types
	*date = 12;
