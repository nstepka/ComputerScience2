...
int main()
{
   ...
   cout<<endl<<left<<setw(25)<<""<<left<<setw(15)<<"number"<<left<<setw(15)<<"cost"<<left<<setw(15)<<"weekly"<<endl;
   
   cout << left << setw(20) << "One bedroom suits" << left << setw(15) << "rented" << left << setw(15) << "per unit" << left << setw(15) << "income"
   ...
   cout << left << setw(20) << "total units" << left << setw(15) << (numOcean+numGarden) << left << setw(15) << "" << left << setw(2) << "$" << left << setw(13) << tCostWeekly
        << left << setw(2) << "$" << left << setw(13) << tCostTax << left << setw(2) << "$" << left << setw(13) << tCostTotal << endl;
